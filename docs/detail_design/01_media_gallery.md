...
![メディア一覧UIモック](../images/detail_design/01_media_gallery_ui.svg)

#### スクロールバー操作

![スクロールバー追従UIモック](../images/detail_design/01_media_gallery_scrollbar_ui.svg)

#### 28列高密度表示

![28列高密度表示UIモック](../images/detail_design/01_media_gallery_dense28_ui.svg)

#### 選択モード

![選択モードUIモック](../images/detail_design/01_media_gallery_selection_ui.svg)

| 番号 | UI部品 | 機能 |
| --- | --- | --- |
| 1 | 通常一覧 | 黒TopAppBar、操作バー、日付ヘッダー、正方形サムネイル、ボトムナビを表示する。 |
| 2 | スクロールバー操作 | ドラッグ中にバー左へ現在位置の年月日ラベルを表示し、グリッドを追従させる。 |
| 3 | 28列高密度表示 | 年単位の俯瞰、1年6段制限、小型サムネイル表示で大量メディアを軽く見渡す。 |
| 4 | 選択モード | 長押し/ドラッグ選択後に選択バーを表示し、お気に入り、その他メニュー、一括操作へ進む。 |

### 4.4. 機能内画面遷移図

通常一覧、28列表示、フィルタ/ソート、選択モード、一括編集、フォルダ移動、ゴミ箱移動の関係を、画面タイトル付きのミニUIモックと矢印で示す。

![メディア一覧 機能内画面遷移図](../images/detail_design/01_media_gallery_transition.svg)
